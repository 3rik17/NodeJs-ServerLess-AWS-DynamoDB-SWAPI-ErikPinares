...
app.get('/importarPlanetas', async (req, res) => {
    try {
        const result = await axios.get('https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/importarPlanetas');
...
app.get('/importarPersonas', async (req, res) => {
    try {
        const result = await axios.get('https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/importarPersonas');
        const json = await JSON.parse(JSON.stringify(result.data));
        res.status(200).send(json);
    } catch(ex) {
        console.log(ex);
...
app.get('/listarPlanetas', async (req, res) => {
    try {
        const result = await axios.get('https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/listarPlanetas');
        const json = await JSON.parse(JSON.stringify(result.data));
        res.status(200).send(json);
    } catch(ex) {
        console.log(ex);
...
app.get('/listarPersonas', async (req, res) => {
    try {
        const result = await axios.get('https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/listarPersonas');
        const json = await JSON.parse(JSON.stringify(result.data));
        res.status(200).send(json);
    } catch(ex) {
        console.log(ex);
...
app.post('/agregarPlaneta', async (req, res, next) => {
  try {
      const result = await axios.post('https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/agregarPlaneta', req.body);
...
app.post('/agregarPersona', async (req, res, next) => {
  try {
      const result = await axios.post('https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/agregarPersona', req.body);
      res.status(200).send(req.body);
  } catch(ex) {
      console.log(ex);
      res.status(500).send(ex.message);
...
app.get('/listaPlaneta/(:id)', async (req, res) => {
  try {
      const result = await axios.get(`https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/listaPlaneta/${req.params.id}`);
      const json = await JSON.parse(JSON.stringify(result.data));
      res.status(200).send(json);
  } catch(ex) {
      console.log(ex);
...
app.get('/listaPersona/(:id)', async (req, res) => {
  try {
      const result = await axios.get(`https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/listaPersona/${req.params.id}`);
      const json = await JSON.parse(JSON.stringify(result.data));
      res.status(200).send(json);
  } catch(ex) {
      console.log(ex);
...
app.post('/editarPlaneta/(:id)', async (req, res, next) => {
  ...
  try {
    ...
    const result = await axios.put(`https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/editarPlaneta/${req.params.id}`, req.query);
...
app.post('/editarPersona/(:id)', async (req, res, next) => {
  ...
  try {
    //console.log(req.params.id)
    const result = await axios.put(`https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/editarPersona/${req.params.id}`, req.query);
    //console.log(result.data.body)
    res.status(200).send(result.data.body);
} catch(ex) {
    console.log(ex);
...
app.delete('/eliminarPlaneta/(:id)', async (req, res) => {
  try {
      const result = await axios.delete(`https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/eliminarPlaneta/${req.params.id}`);
      const json = await JSON.parse(JSON.stringify(result.data));
      res.status(200).send(json);
  } catch(ex) {
      console.log(ex);
...
app.delete('/eliminarPersona/(:id)', async (req, res) => {
  try {
      const result = await axios.delete(`https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/eliminarPersona/${req.params.id}`);
      const json = await JSON.parse(JSON.stringify(result.data));
      res.status(200).send(json);
  } catch(ex) {
      console.log(ex);
