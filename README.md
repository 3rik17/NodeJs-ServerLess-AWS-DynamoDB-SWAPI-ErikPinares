...
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/importarPlanetas

```http
  GET /importarPersonas
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/importarPersonas
...
```http
  GET /listarPlanetas
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/listarPlanetas

```http
  GET /listarPersonas
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/listarPersonas
...
```http
  POST /agregarPlaneta
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/agregarPlaneta
...
```http
  POST /agregarPersona
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/agregarPersona
...
```http
  GET /listaPlaneta/${id}
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/listaPlaneta/a824da4f-e0f3-493e-8730-c04d32d5d9a6
...
```http
  GET /listaPersona/${id}
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/listaPersona/10b49fcc-f2a5-4f0c-a364-40f05dccd4ea
...
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/editarPlaneta/189ae501-6a63-4499-b053-41f5b4ea7fee
...
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/editarPersona/63bfa3be-503a-44c3-baeb-43d7db4fad7f
...
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/eliminarPlaneta/189ae501-6a63-4499-b053-41f5b4ea7fee
...
```
https://l8kcejwtve.execute-api.us-east-1.amazonaws.com/eliminarPersona/63bfa3be-503a-44c3-baeb-43d7db4fad7f
